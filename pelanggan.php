...
<html lang="en">
    <head>
        ...
        <title>Pelanggan - KOPDES MERPUT</title>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-2">
                                    <div class="card-body">Total Pelanggan : <?=$h2;?></div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                ...
                                <button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#myModal">Tambah Pelanggan</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="number" name="notelp" class="form-control mt-2" placeholder="Nomor Telepon" required>
                                            <input type="text" name="alamat" class="form-control mt-2" placeholder="Alamat Pelanggan" required>
                                    ...
                                    <thead>
                                      ...
                                      <tbody>
                                        ...
                                        while($p= mysqli_fetch_array($get)){
                                            ...
                                            $notelp = $p['notelp'];
                                            $alamat = $p['alamat'];
                                            $id_pelanggan = $p['id_pelanggan']; // Mengambil ID Pelanggan untuk target modal dan input hidden
                                        ?>
                                        ...
                                        <div id="edit<?=$id_pelanggan;?>" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form method="post" action=""> 
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="namapelanggan" class="form-control mb-2" value="<?=$nama_pelanggan;?>" required>
                                                            
                                                            <label class="form-label font-weight-bold">No Telepon</label>
                                                            <input type="text" name="notelp" class="form-control mb-2" value="<?=$notelp;?>" required>
                                                            
                                                            <label class="form-label font-weight-bold">Alamat</label>
                                                            <input type="text" name="alamat" class="form-control mb-2" value="<?=$alamat;?>" required>
                                                            
                                                            <!-- Input hidden ID Pelanggan -->
                                                            <input type="hidden" name="idpl" value="<?=$id_pelanggan;?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="editpelanggan">Simpan Perubahan</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                        </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div id="delete<?=$id_pelanggan;?>" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form method="post" action=""> 
                                                        <div class="modal-body">
                                                            Apakah anda yakin ingin menghapus pelanggan <strong><?=$nama_pelanggan;?></strong> secara permanen dari sistem?
